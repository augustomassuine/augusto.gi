...
<div class="container-fluid estrutura">
  ...
  <aside class="col-sm-2 ">
   <div class="nav flex-column nav-pills" id="v-pills-tab" role="" aria-orientation="vertical">
      ...
      <a class="nav-link<?php if($activo==3){?> active <?php }?>"  href="dividaSuper.php" role="tab" >DÍVIDAS  <span style="font-size: 13pt;" class="glyphicon glyphicon-export"></span></a>
      <a class="nav-link<?php if($activo==4){?> active <?php }?>"  href="pagamentoSuper.php" role="tab" >PAGAMENTOS  <span style="font-size: 13pt;" class="glyphicon glyphicon-log-in"></span></a>
      <a class="nav-link<?php if($activo==5){?> active <?php }?>"  href="relatorioSuper.php" role="tab" >RELATÓRIO <span style="font-size: 13pt;" class="glyphicon glyphicon-file"> </span></a>
